...
public class InputFileParserTest {
    ...
    public void dataShouldBeImportedCorrectly() throws FileNotFoundException {
        ...
        FundOperation op2 = new FundOperation("29-07-2009", "30-07-2009", "AAS", TransactionType.PURCHASE, new Money(200.00), new Money(200.01));
        FundOperation op3 = new FundOperation("29-07-2009", "30-07-2009", "AAMS", TransactionType.PURCHASE, new Money(200.00), new Money(200.00));
        FundOperation op4 = new FundOperation("27-08-2009", "28-08-2009", "PANEF", TransactionType.PURCHASE, new Money(100.00), new Money(214.28));
